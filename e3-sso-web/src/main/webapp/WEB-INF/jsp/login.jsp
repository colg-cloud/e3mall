...
<title>e3 商城 - 登录</title>
<link rel="icon" href="/static/icon/favicon.ico">
<link rel="stylesheet" type="text/css" href="/static/css/jquery.alerts.css"/>
<link rel="stylesheet" type="text/css" href="/static/css/headerfooterindex.css"/>
<link rel="stylesheet" type="text/css" href="/static/css/login.css"/>
<script type="text/javascript" src="/static/js/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="/static/js/jquery.cookie.js"></script>
<script type="text/javascript" src="/static/js/jquery.alerts.js"></script>
<script type="text/javascript" src="/static/js/png.js"></script>
<script type="text/javascript" src="/static/js/cas.login.js"></script>
<script type="text/javascript" src="/static/js/capsLock.js"></script>
</head>
<body>
  <!-- header -->
  <div class="header">
    <a href="${content_url}"><img src="/static/images/logo.png" border="0"><span>欢迎登录</span></a>
  </div>
  <!-- login_main -->
  <div class="login_main clear">
    <div class="pic">
      <a href="http://www.e3mall.cn/html/activity/1472720729.html" target="_blank"><img src="/static/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
    </div>
    <!-- login -->
    <div class="login">
      <div class="login_header">
        <span>您还未登录</span> <a href="/sso/register">免费注册</a>
      </div>
            ...
            <form id="formlogin" method="post">
              ...
              <li>
                ...
                <span class="border" style="position: relative">
                  ...
                  <input class="new-input1 new-color" tabindex="1" data-clear-btn="true" id="loginname" size="25" autocomplete="off" htmlescape="true"
                         title="请输入用户名">
              ...
              <li class="m-t5" id="btn_sub">
                ...
                <input type="hidden" name="_eventId" value="submit"> <a href="javascript:" id="login_sub" class="login_btn">登录</a>
              </li>
              <div></div>
            </form>
          </ul>
        ...
        <ul class="blink">
          <li class="p-f10">
            ...
            <div>
              ...
              <a href="https://api.weibo.com/oauth2/authorize?client_id=1800908332&amp;redirect_uri=https%3A%2F%2Fpassport.e3mall.cn%2Fcallback%2Fsina&amp;response_type=code&amp;state=&amp;display=?returnUrl=http://www.e3mall.cn/"
                 class="link">新浪微博</a> &nbsp;|&nbsp;
              <a href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801198099&amp;redirect_uri=https%3A%2F%2Fpassport.e3mall.cn%2Fcallback%2Fqq&amp;response_type=code&amp;type=?returnUrl=http://www.e3mall.cn/"
                 class="link">腾讯微博</a> &nbsp;|&nbsp;
  ...
  <!-- /login_main -->
  <div class="footer">
    <span> <a href="http://www.e3mall.cn/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> |
    ...
    <p>
      ...
      Copyright© e3 商城 e3mall.cn 版权所有<br>
    </p>
  </div>
  <!-- /footer -->
