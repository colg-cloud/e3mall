...
<title>e3 商城 - 注册(个人用户)</title>
<link rel="icon" href="/static/icon/favicon.ico">
<link rel="stylesheet" href="/static/css/headerfooter.css"/>
<link rel="stylesheet" href="/static/css/jquery.alerts.css"/>
<link rel="stylesheet" href="/static/css/headerfooterindex.css"/>
<script src="/static/js/jquery-1.5.1.min.js"></script>
<script src="/static/js/jquery.cookie.js"></script>
<script src="/static/js/passport.common.js?v20140531"></script>
<script src="/static/js/jquery.alerts.js"></script>
<script src="/static/js/png.js?v20140521"></script>
</head>
<body>
  <!-- header -->
  <div class="header">
    <a href="${content_url}"><img src="/static/images/logo.png" border="0"/><span>欢迎注册</span></a>
  </div>

  <!--mainStart-->
  <link rel="stylesheet" href="/static/css/reg.css?v20140432"/>
  <script src="/static/js/allMail.js?v20140430"></script>
  <script src="/static/js/reg.js?v20150122"></script>
  <!-- reg_main -->
  <div class="tabBox clear">
    ...
    <div class="login">已有账号，立即 <a href="/sso/login">登录</a></div>
  </div>
  <!--个人用户-->
      ...
      <form id="regForm_mod" name="regForm_mod" method="post">
        <li class="regMb30">
          ...
          <span class="regM defaultBorder">
            <input id="regName" name="username" class="regInput" type="text" onkeyup="mail_div(event);" onfocus="showtip('regName','userMamErr',8);"
        ...
        <li>
          ...
          <span class="regM defaultBorder">
            <input id="pwd" name="password" class="regInput" autocomplete="off" type="password" onfocus="showPwdtip('password','passwordErr',2);"
                   onkeyup="ckpwd(0,1);" onblur="ckpwd(0,0);"/>
            <em></em>
          </span>
        ...
        <li class="regMb30">
          ...
          <span class="regM defaultBorder">
            <input id="pwdRepeat" name="password2" autocomplete="off" class="regInput" type="password" onfocus="showtip('password2','password2Err',3);"
                   onblur="ckpwd2();"/>
            <em></em>
          </span>
        ...
        <li class="regMb30">
          ...
          <span class="regM defaultBorder">
            <input id="phone" name="phone" autocomplete="off" class="regInput" type="text" maxlength="11" onfocus="showtip('phone','phoneErr',1);"
        ...
        <li class="regPl88">
          <span class="regM" style="margin-left:29px">
            ...
            <a href="https://passport.e3mall.cn/xy.html" target="_blank" class="checkTitle">我已阅读并同意<font style="font-size:12px;">《e3 商城用户注册协议》</font></a>
          </span>
        ...
        <li class="register regPl88 regMt10" id="sub_per" style="margin-left:29px">
          ...
          <a href="javascript:" class="registerNow" id="reg_per_data" onclick="REGISTER.reg()">立即注册</a>
        </li>
        <br/><br/>
      </form>
    </ul>
  ...
  <script>
    var REGISTER = {
      ...
      doSubmit: function () {
        $.post('/sso/user/register', $('#regForm_mod').serialize(), function (data) {
          if (data.status == 200) {
