...
<div class="topMenu">
    ...
    <ul class="fr topTh">
      <li class="login" id="login">
        <span id="loginbar" style="margin-right: 15px;">
          <a href="${sso_login_url}">请登录</a>
        </span>
        <a href="${sso_register_url}">免费注册</a>
      </li>
        ...
        <div class="dd">
          ...
          <dl>
            ...
            <dd>
              ...
              <a name="sfbest_hp_hp_head_channel3" class="trackref" href="/wine/" target="_blank">红酒廊</a><a
                name="sfbest_hp_hp_head_channel4" class="trackref" href="/taste/" target="_blank">寰宇美食</a>
  ...
  <script src="/static/js/e3mall.js"></script>
