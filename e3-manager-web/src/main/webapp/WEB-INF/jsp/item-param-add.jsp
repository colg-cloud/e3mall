  ...
  <li class="param">
    <ul>
      <li>
        ...
        <a href="javascript:" class="easyui-linkbutton addParam" title="添加参数" data-options="plain:true,iconCls:'icon-add'"></a>
      </li>
      <li>
        <span>|-------</span><input style="width: 150px;" class="easyui-textbox" name="param"/>
        <a href="javascript:" class="easyui-linkbutton delParam" title="删除" data-options="plain:true,iconCls:'icon-cancel'"></a>
      </li>
    </ul>
  </li>
</div>
<script>
  $(function () {
    ...
    $('#itemParamAddTable .close').click(function () {
    	E3.closeWindow('#itemParamAddTable')
    })
