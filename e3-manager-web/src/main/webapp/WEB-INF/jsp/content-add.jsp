...
<div style="padding:10px 10px 10px 10px">
  ...
  <div style="padding:5px">
    <a href="javascript:" class="easyui-linkbutton" onclick="contentAddPage.submitForm()">提交</a>
    <a href="javascript:" class="easyui-linkbutton" onclick="contentAddPage.clearForm()">重置</a>
  </div>
</div>
<script>
  ...
  var contentAddPage = {
    submitForm: function () {
      ...
      $.post('/manager/content/save', $('#contentAddForm').serialize(), function (data) {
        if (data.status === 200) {
