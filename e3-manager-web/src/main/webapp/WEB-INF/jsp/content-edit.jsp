...
<div style="padding:10px 10px 10px 10px">
  ...
  <div style="padding:5px">
    <a href="javascript:" class="easyui-linkbutton" onclick="contentEditPage.submitForm()">提交</a>
    <a href="javascript:" class="easyui-linkbutton" onclick="contentEditPage.clearForm()">重置</a>
  </div>
</div>
<script>
  ...
  var contentEditPage = {
    submitForm: function () {
      ...
      $.post('/manager/content/edit', $('#contentEditForm').serialize(), function (data) {
        if (data.status === 200) {
